...
1. Komariの[GitHubリリース](https://github.com/rabbits0209/komari/releases)ページにアクセスして、お使いのオペレーティングシステム用の最新のバイナリをダウンロードします。
2. Komariを実行します:
   ```bash
...
[![Sharon Networks](https://raw.githubusercontent.com/rabbits0209/public/refs/heads/main/images/sharon-networks.webp)](https://sharon.io)
